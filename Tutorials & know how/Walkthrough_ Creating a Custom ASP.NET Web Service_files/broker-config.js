...
//Array [PATH,SITE_CODE,FREQ]
var _technet = [ ["default.aspx",'1219',0.3],["library",'1192',0.3],["cloud",'2201',0.3],["network",'2200',0.3],["sbs",'2199',0.3],["windowsserver",'1194',0.0815],["forefront",'1011',0.3],["sqlserver",'1197',0.3],["systemcenter",'1198',0.3],["windows",'1199',0.0036],["scriptcenter",'1200',0.3],["security",'1202',0.3],["subscriptions",'1206',0.3],["sysinternals",'1203',0.1327] ];
...
function checkWTSP(){
	 ...
	 if(_Site == '1176'){
		...
		if(!(/technet_(library_(windowsserver_|sqlserver_|forefront|security_|exchangeserver_|windowsserveressentials_))|sto_technet_systemcenter_|sto_technet_windowsclient_library_|scriptcenter_technet/i.test(_wtsp))){
				_halt=true;
